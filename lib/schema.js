...
const typeDefs = `
  ...
  type Mutation {
    ...
    updateCustomCredentials(resourceId: ID!, key: String, value: String): KeyValuePair
  }
`;
...
const resolvers = {
  ...
  Mutation: {
    ...
    updateCustomCredentials(_, { resourceId, key, value }) {
      return patchCustomCredentials(resourceId, { [key]: value });
    }
  },
  Provider: {
    products(provider) {
